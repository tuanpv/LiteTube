...
import com.liteyoutube.youtubelite.BaseFragment;
...
import com.liteyoutube.youtubelite.util.InfoCache;
...
public abstract class BaseStateFragment<I> extends BaseFragment implements ViewContract<I> {
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        emptyStateView = rootView.findViewById(com.liteyoutube.youtubelite.R.id.empty_state_view);
        loadingProgressBar = rootView.findViewById(com.liteyoutube.youtubelite.R.id.loading_progress_bar);

        errorPanelRoot = rootView.findViewById(com.liteyoutube.youtubelite.R.id.error_panel);
        errorButtonRetry = rootView.findViewById(com.liteyoutube.youtubelite.R.id.error_button_retry);
        errorTextView = rootView.findViewById(com.liteyoutube.youtubelite.R.id.error_message_view);
    }
    ...
    protected boolean onError(Throwable exception) {
        ...
        if (exception instanceof ReCaptchaException) {
            ...
            showError(getString(com.liteyoutube.youtubelite.R.string.network_error), true);
            return true;
        }
    ...
    public void onReCaptchaException() {
        ...
        Toast.makeText(activity, com.liteyoutube.youtubelite.R.string.recaptcha_request_toast, Toast.LENGTH_LONG).show();
        // Starting ReCaptcha Challenge Activity
        startActivityForResult(new Intent(activity, ReCaptchaActivity.class), ReCaptchaActivity.RECAPTCHA_REQUEST);

        showError(getString(com.liteyoutube.youtubelite.R.string.recaptcha_request_toast), false);
    }
    ...
    protected void openUrlInBrowser(String url) {
        ...
        startActivity(Intent.createChooser(intent, activity.getString(com.liteyoutube.youtubelite.R.string.share_dialog_title)));
    }
    ...
    protected void shareUrl(String subject, String url) {
        ...
        startActivity(Intent.createChooser(intent, getString(com.liteyoutube.youtubelite.R.string.share_dialog_title)));
    }
}
