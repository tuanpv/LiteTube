...
public class InfoListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setOnChannelSelectedListener(InfoItemBuilder.OnInfoItemSelectedListener<ChannelInfoItem> listener) {
        infoItemBuilder.setOnChannelSelectedListener(listener);
    }

    public void setOnPlaylistSelectedListener(InfoItemBuilder.OnInfoItemSelectedListener<PlaylistInfoItem> listener) {
