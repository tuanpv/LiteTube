...
public class FilenameUtils {
    ...
    public static String createFilename(Context context, String title) {
        ...
        final String key = context.getString(com.liteyoutube.youtubelite.R.string.settings_file_charset_key);
        final String value = sharedPreferences.getString(key, context.getString(com.liteyoutube.youtubelite.R.string.default_file_charset_value));
        Pattern pattern = Pattern.compile(value);

        final String replacementChar = sharedPreferences.getString(context.getString(com.liteyoutube.youtubelite.R.string.settings_file_replacement_character_key), "_");
